...
New-VM -Name NewVM -path C:\ProgramData\Microsoft\Windows\Hyper-V -MemoryStartupBytes 512MB

#2.6. Создать динамический жесткий диск

New-VHD -Path E:\Hyper-V\Virtual hard disks\NewVM.vhdx -SizeBytes 10GB -Dynamic

#Добавляем созданный виртуальный диск к ВМ
Add-VMHardDiskDrive -VMName NewVM -path "E:\Hyper-V\Virtual hard disks\NewVM.vhdx"
